  ...
  outputs = { self, nixpkgs, nixpkgs-pinned, flake-utils, drpc, pnpm2nix }:
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        # The minimal set of packages to build Wirtual.
        ...
        buildFat = osArch:
          pkgs.buildGo122Module {
            ...
            vendorHash = "sha256-5ZHRRx/BLQQ+vcgbUYvR0seDLoREZn/LmZebVKQop4o=";
            proxyVendor = true;
            src = ./.;
            ...
            buildPhase = ''
              ...
              make -j build/wirtual_${osArch}
            '';
            installPhase = ''
              mkdir -p $out/bin
              cp -r ./build/wirtual_${osArch} $out/bin/wirtual
            '';
          };
      in
      {
