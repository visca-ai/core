...
func TestEscapePostgresURLUserInfo(t *testing.T) {
	...
	testcases := []struct {
		...
		{
			input:  "postgres://wirtual:wirtual@localhost:5432/wirtual",
			output: "postgres://wirtual:wirtual@localhost:5432/wirtual",
			err:    nil,
		},
		{
			input:  "postgres://wirtual:co{der@localhost:5432/wirtual",
			output: "postgres://wirtual:co%7Bder@localhost:5432/wirtual",
			err:    nil,
		},
		{
			input:  "postgres://wirtual:co:der@localhost:5432/wirtual",
			output: "postgres://wirtual:co:der@localhost:5432/wirtual",
			err:    nil,
		},
		{
			input:  "postgres://wirtual:co der@localhost:5432/wirtual",
			output: "postgres://wirtual:co%20der@localhost:5432/wirtual",
			err:    nil,
		},
		{
			input:  "postgres://local host:5432/wirtual",
			output: "",
			err:    xerrors.New("parse postgres url: parse \"postgres://local host:5432/wirtual\": invalid character \" \" in host name"),
		},
	}
	for _, tc := range testcases {
		tc := tc
