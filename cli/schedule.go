...
import (
	...
	"github.com/wirtualdev/wirtualdev/v2/wirtuald/schedule/cron"
	"github.com/wirtualdev/wirtualdev/v2/wirtuald/util/ptr"
	"github.com/wirtualdev/wirtualdev/v2/wirtuald/util/tz"
	...
	cmd := &serpent.Command{
		...
		Long: scheduleStartDescriptionLong + "\n" + FormatExamples(
			Example{
				...
				Command:     "wirtual schedule start my-workspace 9:30AM Mon-Fri Europe/Dublin",
			},
		),
...
func (r *RootCmd) scheduleStop() *serpent.Command {
	...
	return &serpent.Command{
		...
		Long: scheduleStopDescriptionLong + "\n" + FormatExamples(
			Example{
				Command: "wirtual schedule stop my-workspace 2h30m",
			},
		),
...
func (r *RootCmd) scheduleOverride() *serpent.Command {
	...
	overrideCmd := &serpent.Command{
		...
		Long: scheduleOverrideDescriptionLong + "\n" + FormatExamples(
			Example{
				Command: "wirtual schedule override-stop my-workspace 90m",
			},
		),
		Middleware: serpent.Chain(
			serpent.RequireNArgs(2),
