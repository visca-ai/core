...
Download the Wirtual command line for your operating system:
https://github.com/wirtualdev/wirtualdev/releases

Run `+pretty.Sprint(cliui.DefaultStyles.Code, "wirtual login "+client.URL.String())+` to authenticate.

Your email is: `+pretty.Sprint(cliui.DefaultStyles.Field, email)+`
`+authenticationMethod+`

Create a workspace  `+pretty.Sprint(cliui.DefaultStyles.Code, "wirtual create")+`!`)
			return nil
		},
	}
