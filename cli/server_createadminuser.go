...
func (r *RootCmd) newCreateAdminUserCommand() *serpent.Command {
	...
	createAdminUserCommand.Options.Add(
		serpent.Option{
			...
			Flag:        "postgres-url",
			Description: "URL of a PostgreSQL database. If empty, the built-in PostgreSQL deployment will be used (Wirtual must not be already running in this case).",
