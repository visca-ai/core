	...
	cmd := &serpent.Command{
		...
		Long: FormatExamples(
			Example{
				...
				Command:     "wirtual dotfiles --yes git@github.com:example/dotfiles.git",
			},
		),
		Handler: func(inv *serpent.Invocation) error {
			var (
				...
				// https://github.com/wirtualdev/wirtualdev/pull/1696#issue-1245742312
			...
			for _, df := range dotfiles {
				...
				// which are typically leftover from a previous call to wirtual dotfiles.  We do this best effort and
