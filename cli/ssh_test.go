...
import (
	...
	"github.com/wirtualdev/wirtualdev/v2/agent"
	"github.com/wirtualdev/wirtualdev/v2/agent/agentssh"
	"github.com/wirtualdev/wirtualdev/v2/agent/agenttest"
	agentproto "github.com/wirtualdev/wirtualdev/v2/agent/proto"
	...
	"github.com/wirtualdev/wirtualdev/v2/wirtuald/workspacestats/workspacestatstest"
...
func TestSSH_ForwardGPG(t *testing.T) {
	...
	// This key is for dean@wirtual.dev.
...
Subkey-Type: 1
Subkey-Length: 2048
Name-Real: Wirtual Test
Name-Email: test@wirtual.dev
Expire-Date: 0
%no-protection
`
	...
	require.Contains(t, listKeysOutput, "[ultimate] Wirtual Test <test@wirtual.dev>")
	require.Contains(t, listKeysOutput, "[ultimate] Dean Sheather (work key) <dean@wirtual.dev>")
...
func tempDirUnixSocket(t *testing.T) string {
	...
	if runtime.GOOS == "darwin" {
		...
		dir, err := os.MkdirTemp("/tmp", fmt.Sprintf("wirtual-test-%s-", testName))
